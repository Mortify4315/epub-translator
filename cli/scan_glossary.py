...
STOPWORDS = {
    "一个", "一个", "一", "是", "不", "了", "有", "这", "那", "我", "你", "他",
    "她", "它", "我们", "你们", "他们", "她们", "它们", "都", "又", "很", "也",
    "就", "在", "着", "过", "吧", "吗", "啊", "呢", "去", "来", "上", "中", "下",
    "要", "会", "能", "可", "把", "被", "对", "从", "向", "为", "以", "于", "和",
    "自己", "没", "别", "同", "与", "等", "地", "得", "然后", "现在", "时候",
    "什么", "怎么", "这样", "那样", "这个", "那个", "已经", "没有", "看见",
    "知道", "觉得", "说道", "一下", "起来", "出来", "只是", "但是", "因为",
    "所以", "如果", "虽然", "可是", "不过", "而且", "或者", "还有", "之后",
    "之前", "以及", "甚至", "于是", "否则", "一边", "一直", "一起", "突然",
    "直接", "开始", "真的", "一点", "一样", "大概", "可以", "不能", "有些",
    "有点", "有点", "好像", "其实", "当然", "应该", "需要", "可能", "几乎",
    "马上", "终于", "立刻", "肯定", "表示", "露出", "听到", "看到", "感觉",
    "望着", "说着", "说道", "淡淡", "狠狠", "默默", "心中", "眼里", "眼前",
    "面前", "背后", "周围", "外面", "里面", "身上", "身边", "手里", "脚下",
    "缓缓", "慢慢", "渐渐", "再次", "重新", "剩下", "第一", "第二", "第三",
    "抬头", "低头", "回头", "点头", "摇头", "脚步", "目光", "声音", "气息",
    "东西", "事情", "地方", "时候", "男人", "女人", "身上", "之中", "之上",
    "之后", "之前", "一边", "然而", "此刻", "瞬间", "接下来", "然后", "接着",
}
